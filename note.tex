...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{结构图原件.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{相加点和分支点.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{无扰动闭环系统.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{有扰动闭环系统.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{串联简化.png}
\end{figure}

并联的简化:传递函数加减
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{并联简化.png}
\end{figure}

反馈回路的简化:
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{反馈回路简化.png}
\end{figure}
\[
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{相加点前移.png}
\end{figure}
\[
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{相加点后移.png}
\end{figure}
\[
